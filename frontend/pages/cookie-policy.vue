<template>
    <div class="container mx-auto max-w-xs md:max-w-6xl">
        ...
        <section class="block my-20">
            <h1>Cookie Policy for Future KNX</h1>

            <p>This is the Cookie Policy for Future KNX, accessible from https://www.futureknx.com</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Surveys related cookies</strong></p>
